...
public class ReporterNewslistAdaptor extends RecyclerView.Adapter<ReporterNewslistAdaptor.ImageViewHolder> {
    private Context mContext;
    private List<News_itemsModel> mUploads;

    public ReporterNewslistAdaptor(Context mContext, List<News_itemsModel> mUploads) {
