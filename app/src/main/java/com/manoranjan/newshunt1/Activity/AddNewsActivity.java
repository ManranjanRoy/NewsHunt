...
public class AddNewsActivity extends AppCompatActivity {
    ...
    public void setplacttotext() {
        ...
        geocoder = new Geocoder(AddNewsActivity.this, Locale.getDefault());
    ...
    private void spinnerdata() {
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(AddNewsActivity.this, android.R.layout.simple_spinner_item, categories);
    ...
    private void addnews() {
        final ProgressDialog loading = ProgressDialog.show(AddNewsActivity.this, "Updating...", "Please wait...", false, false);
            ...
            public void onResponse(Call<CategoryResponse> call, Response<CategoryResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    if (response.body().getError().equals("false")) {
                        ...
                        ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(AddNewsActivity.this,
                        ...
                        spinnercategory.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                ...
                                // Toast.makeText(AddNewsActivity.this, item, Toast.LENGTH_SHORT).show();
